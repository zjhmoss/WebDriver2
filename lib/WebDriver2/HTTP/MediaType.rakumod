unit class WebDriver2::HTTP::MediaType;
...
my class MediaTypeAction {
    ...
    method media-type($/) {
        $/.make: WebDriver2::HTTP::MediaType.new(
...
method charset(WebDriver2::HTTP::MediaType:D:) returns Str {
...
method Str(WebDriver2::HTTP::MediaType:D:) {
    my Str $s = $.type;
    if %!parameters {
