...
unit class WebDriver2::HTTP::Request is WebDriver2::HTTP::Message;
...
multi method new(RequestMethod $method, URI $uri, WebDriver2::HTTP::Header $header, Bool :$bin) {
...
multi method add-form-data(Array $data, :$multipart) {
    ...
    given $ct {
        ...
        when m:i,^ "multipart/form-data" \s* ( ";" | $ ), {
            ...
            my $mt = WebDriver2::HTTP::MediaType.parse($ct);
    ...
    for @$content {
        ...
        given $v {
            ...
            when Array {
                ...
                my $content;
                my $headers = WebDriver2::HTTP::Header.new(|@headers);
                if ($file) {
...
WebDriver2::HTTP::Request - class encapsulating HTTP request message

=head1 SYNOPSIS

    use WebDriver2::HTTP::Request;
    my $request = WebDriver2::HTTP::Request.new(GET => 'http://www.example.com/');
...
=head2 method new
    ...
    multi method new(Str $method, URI $uri, WebDriver2::HTTP::Header $header);
...
=item field => values, header fields
    ...
    my $req = WebDriver2::HTTP::Request.new(:GET<example.com>, :h1<v1>);
...
Sets a method of the request.
    ...
    my $req = WebDriver2::HTTP::Request.new;
    $req.set-method: 'POST';
...
=head2 method add-cookies
    ...
    method add-cookies(WebDriver2::HTTP::Cookies $cookies)

This will cause the appropriate cookie headers to be added from the
supplied WebDriver2::HTTP::Cookies object.
...
=head2 method parse
    ...
    method parse(Str $raw_request) returns WebDriver2::HTTP::Request
